...
public class SortAnalyzer {
    ...
    public static final long[] insertionCompares = new long[5];
    public static final long[] selectionCompares = new long[5];
    public static final long[] mergeCompares = new long[5];
    public static final long[] quickCompares = new long[5];


    static Random random = new Random();

    static Comparable[] sortedArray = new Comparable[10];
    static Comparable[] reverseArray = new Comparable[10];
    static Comparable[] randomArray = new Comparable[10];
    ...
    public static void resetData(){
        ...
        for(var i = 0; i < 10; ++i){
            sortedArray[i] = i + 1;
            reverseArray[i] = (11 - (i + 1));

            randomArray[i] = random.nextInt((max - min) + 1) + min;
        }
    }

    private static void arrayOfCompares(){
